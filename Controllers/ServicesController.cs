...
namespace AFFILIATES.GB
{
    ...
    public class ServicesController : Controller
    {
        ...
        public ServicesController(AffiliatesDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,ServiceName,Description")] Services services)
        {
            if (id != services.Id)
            {
                return NotFound();
